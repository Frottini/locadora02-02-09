...
namespace WindowsFormsApp1
{
    public partial class formLocadora : Form
    {
        ...
        private void brInserir_Click(object sender, EventArgs e)
        {
            MySqlConnectionStringBuilder conexaoBD = conexaoBanco();
            MySqlConnection realizaConexacoBD = new MySqlConnection(conexaoBD.ToString());
            try
            {
                ...
                comandoMySql.CommandText = "INSERT INTO filme (nomeFilme,categoriaFilme,descricaoFilme,anoFilme) " + "VALUES('" + tbNome.Text + "', '" + tbCategoria.Text + "','" + tbDescricao.Text + "', " + Convert.ToInt16(tbAno.Text) + ")";
        ...
        private void btAlterar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                comandoMySql.CommandText = "UPDATE filme SET nomeFilme = '" + tbNome.Text + "', " + "descricaoFilme = '" + tbDescricao.Text + "', " + "categoriaFilme = '" + tbCategoria.Text + "', " + "anoFilme = " + Convert.ToInt16(tbAno.Text) + " WHERE idFilme = " + tbID.Text + "";
                comandoMySql.ExecuteNonQuery();
